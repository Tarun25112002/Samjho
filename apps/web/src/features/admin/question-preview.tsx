...
export function QuestionPreview({
  ...
  if (draft.body.trim().length === 0) {
    return (
      <div className="border-line bg-raised text-text-soft rounded-control border p-4 text-sm leading-relaxed">
  ...
  return (
    <div className="border-line bg-raised rounded-control border p-4">
